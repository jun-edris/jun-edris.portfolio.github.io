	...
	return (
		<section className='mt-24 lg:mt-72'>
			...
			<p className='xl:w-[650px] text-wrap text-gray-400 my-5 text-sm sm:text-base'>
				I'm a Fullstack Web Developer residing in Philppines specializing in building MERN stack web apps. Currently,
				I'm working as a Web Designer to gain experience in Frontend.
			</p>
